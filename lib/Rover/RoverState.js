...
function useRoverState(initialState) {
  ...
  var _useSealedState = useSealedState.useSealedState(initialState),
      ...
      sealed = _rollupPluginBabelHelpers._objectWithoutPropertiesLoose(_useSealedState, ["currentId", "loop"]);

  var _React$useReducer = React.useReducer(reducer, _rollupPluginBabelHelpers._objectSpread2({}, sealed, {
    stops: [],
    currentId: currentId,
    unstable_pastId: null,
    unstable_moves: 0,
